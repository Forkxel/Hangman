...
/**
 * This class is for easy difficulty
 */
public class Easy {
    ...
    /**
     * This is used to print out easy difficulty
     */
    public void out() {
        word();
        int wrong = 0;
        ...
        while (game){
            ...
            if (word()){
                ...
                System.out.println("To win you needed a " + atempts + " attempts");
                game = false;
            }
            if (wrong == 6){
